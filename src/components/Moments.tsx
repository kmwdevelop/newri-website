        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
          {SEASONS.map((s, i) => (
            <Reveal key={s.label} delay={i * 0.06}>
              <div className="group relative aspect-[16/10] overflow-hidden rounded-3xl shadow-soft-sm">
                <Image
                  src={s.src}
                ...
                />
                <span className="absolute left-4 top-4 rounded-full bg-card px-3 py-1 text-xs font-bold text-ink shadow-soft-sm">
                  {s.label}
                </span>
              </div>
            </Reveal>
